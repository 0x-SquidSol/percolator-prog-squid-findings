...
#[test]
fn test_set_oracle_price_cap_requires_signer() {
    let mut f = setup_market();
    let init_data = encode_init_market(&f, 100);
    ...
    // Build SetOraclePriceCap (tag 18): [18, max_change_e2bps(u64)].
    let mut ix_data = vec![percolator_prog::tags::TAG_SET_ORACLE_PRICE_CAP];
