...
#[test]
fn test_set_insurance_isolation_requires_signer() {
    let mut f = setup_market();
    let init_data = encode_init_market(&f, 100);
    ...
    // SetInsuranceIsolation (tag 42): [42, bps(u16)]
    let mut ix_data = vec![percolator_prog::tags::TAG_SET_INSURANCE_ISOLATION];
